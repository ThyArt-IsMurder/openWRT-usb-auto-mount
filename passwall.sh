...
rm -f passthewall2.sh && wget https://raw.githubusercontent.com/ThyArt-IsMurder/passthewall/main/passthewall2.sh && chmod 777 passthewall2.sh && sh passthewall2.sh
